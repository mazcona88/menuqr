...
//ejemplo
//http://localhost:8080/Cartas/menu.php?empresa=BLACKFOX
...
$query_categorias = mysqli_query($conection, "SELECT DISTINCT categoria FROM cartas WHERE empresa='$empresa'");
...
<?php
    ...
    $query_productos = mysqli_query($conection, "SELECT * FROM cartas WHERE categoria = '$categoria_nombre' AND empresa = '$empresa' AND estatus = 1");
